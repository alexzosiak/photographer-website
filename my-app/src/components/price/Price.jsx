        ...
        <>
            ...
            <ul className="price__list">
                <li className="price__card">
                    <Image className="price__card-img" src={img1} alt="" />
                    <h3 className="price__card-title">MINI</h3>
                    <ul className="price__card-list">
                        ...
                        <li className="price__card-item">
                            <span>
                                Assistance in selecting a location and styling
                            </span>
                        </li>
                        <li className="price__card-item">
                            <span>
                                Artistic editing of all photos (60+) with light
                                retouching
                            </span>
                        </li>
                        <li className="price__card-item">
                            <span>
                                Final photos ready in 10-15 days (delivered via
                                an online gallery)
                            </span>
                        </li>
                    </ul>
                ...
                <li className="price__card">
                    <Image className="price__card-img" src={img2} alt="" />
                    ...
                    <ul className="price__card-list">
                        ...
                        <li className="price__card-item">
                            <span>
                                Artistic editing of all photos (100+) with light
                                retouching
                            </span>
                        </li>
                        <li className="price__card-item">
                            <span>
                                Final photos ready within 10-20 days (delivered
                ...
                <li className="price__card">
                    <Image className="price__card-img" src={img3} alt="" />
                    ...
                    <ul className="price__card-list">
                        ...
                        <li className="price__card-item">
                            <span>
                                Artistic editing of all photos (150+) with light
                                retouching
                            </span>
                        </li>
                        <li className="price__card-item">
...
const FamilyPrice = () => {
    return (
        <>
            <h2 className="price__title">FAMILY AND COUPLE PRICING PACKAGES </h2>
            <ul className="price__list">
                <li className="price__card">
                    <Image className="price__card-img" src={img1} alt="" />
                    <h3 className="price__card-title">MINI</h3>
